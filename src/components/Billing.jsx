  ...
  return (
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aspernatur reiciendis possimus voluptas temporibus rem impedit earum aliquid, laudantium laborum tempora!</p>
